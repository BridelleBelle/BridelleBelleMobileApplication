...
namespace BridelleBelleMobileApplication.Controller
{
	public class PageView : ScrollView
	{
		...
		public static readonly BindableProperty ItemsSourceProperty =
			BindableProperty.Create<PageView, IList>(
				view => view.ItemsSource,
				default(IList),
				BindingMode.TwoWay,
				propertyChanging: (bindableObject, oldValue, newValue) => {
					((PageView)bindableObject).ItemsSourceChanging();
				},
				propertyChanged: (bindableObject, oldValue, newValue) => {
					((PageView)bindableObject).ItemsSourceChanged(bindableObject, oldValue, newValue);
				}
			);
		...
		public static readonly BindableProperty SelectedItemProperty =
			BindableProperty.Create<PageView, object>(
				view => view.SelectedItem,
				null,
				BindingMode.TwoWay,
				propertyChanged: (bindable, oldValue, newValue) => {
					((PageView)bindable).UpdateSelectedIndex();
				}
			);
		...
		public static readonly BindableProperty SelectedIndexProperty =
			BindableProperty.Create<PageView, int>(
				carousel => carousel.SelectedIndex,
				0,
				BindingMode.TwoWay,
				propertyChanged: (bindable, oldValue, newValue) => {
					((PageView)bindable).UpdateSelectedItem();
				}
			);
